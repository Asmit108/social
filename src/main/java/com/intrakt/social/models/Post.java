...
public class Post {
    ...
    @JoinColumn(
            ...
            foreignKey = @ForeignKey(name = "fk_create_user_id", foreignKeyDefinition = "FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE") // DB-level cascade on delete
    )
    private User user;
